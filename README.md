...
Также оркестратор хранит данные о задачах и выражениях.
...
* Происходит по HTTP (RESTful API).
* Идентификаторы имеют тип int64.
* Выражения хранятся в SQLite.
...
Инструкции по установке Docker доступны на [официальном сайте](https://www.docker.com/get-started/).
...
TODO: Переместить раздел в отдельный файл.
